...
#frames and pcm values coming soon
highlevel={}
######################################
## higlevel extracted feature url's ##
######################################
### BERT-> 2018 word embeddings
### GloVe
### FACET -> video features
...
#highlevel["OpenSmile-emobase2010"]='http://immortal.multicomp.cs.cmu.edu/CMU-MOSI/acoustic/CMU_MOSI_OpenSmile.csd'
